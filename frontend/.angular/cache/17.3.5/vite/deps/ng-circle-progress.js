...
CircleProgressComponent.ɵfac = function CircleProgressComponent_Factory(t) {
  return new (t || CircleProgressComponent)(ɵɵdirectiveInject(CircleProgressOptions), ɵɵdirectiveInject(NgZone), ɵɵdirectiveInject(ElementRef), ɵɵdirectiveInject(Injector));
};
CircleProgressComponent.ɵcmp = ɵɵdefineComponent({
  ...
  inputs: {
    ...
    lazy: "lazy",
    templateOptions: [InputFlags.None, "options", "templateOptions"]
  },
  outputs: {
    onClick: "onClick"
  },
